...
def run_level3_checks(img_cv, img_pil, filename="", file_format="", config_override=None):
    """
    Run Level 3 checks: Text-heavy, Document-like, Synthetic, and [NEW] Web/Download indicators.
